...
public class BirthdayDto implements Serializable {
    ...
    public BirthdayDto(int id, @NonNull String name, int day, int month, int year) {
        _id = id;
        _name = name;
        _day = day;
        _month = month;
    ...
    public boolean HasBirthday() {
        return _day == _today.get(Calendar.DAY_OF_MONTH) && _month == (_today.get(Calendar.MONTH) + 1);
    }
}